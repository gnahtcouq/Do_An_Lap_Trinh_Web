...
<head>
    <?php require '../view/layouts/headerpage.php'; ?>

</head>

<body>
    <?php require '../view/layouts/menupage.php'; ?>
    <?php require '../view/layouts/menubottompage.php'; ?>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="contact-info">
                        <h2>Liên hệ</h2>
                        <p><i class="fa fa-map-marker"></i>180 Cao Lỗ, phường 4, quận 8, HCM</p>
                        <p><i class="fa fa-envelope"></i>contact@tiemnhatui.live</p>
                        <p><i class="fa fa-phone"></i>0866.085.276</p>
                        <div class="social">
                            <a href="https://www.instagram.com/tiemnhatui/" target="_blank"><i
    ...
    <?php require '../view/layouts/footerpage.php'; ?>
    <?php require '../view/layouts/footerbottompage.php'; ?>
    <a href="#" class="back-to-top"><i class="fa fa-chevron-up"></i></a>
    <?php require '../view/layouts/scriptpage.php'; ?>
</body>
